...
class CredentialStore:
    ...
    def __init__(self, storage_path: str = ".credentials.enc"):
        ...
        logger.info(
            f"CredentialStore initialized (keyring: {
    ...
    def _derive_key(self, password: str, salt: bytes) -> bytes:
        ...
        # Use standard library implementation which acts as a fallback and is
        # secure enough
    ...
    def store(
        ...
        try:
            ...
            if not master_password:
                ...
                if not master_password:
                    logger.error(
                        "Master password required for credential storage!")
                    raise ValueError(
    ...
    def delete(self, key: str, master_password: Optional[str] = None) -> bool:
        ...
        try:
            ...
            if not master_password:
                ...
                if not master_password:
                    logger.error(
                        "Master password required for credential deletion")
