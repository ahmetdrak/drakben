...
async def main():
    ...
    if WAFEvasion:
        ...
        console.print("   [red]✘ WAF Module failed to load.[/red]")
    ...
    if SQLiteProvider:
        ...
        console.print("   [red]✘ Database Module failed to load.[/red]")
    ...
    if PostExploitEngine:
        ...
        console.print("   [red]✘ Post-Exploit Module failed to load.[/red]")
