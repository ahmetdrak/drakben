...
class BloodHoundAnalyzer:
    ...
    def find_shortest_path(
        ...
        while queue:
            ...
            if current == target_id:
                # Build attack chain
                techniques = [
                    self._edge_to_technique(e) for e in path
                ]
                return AttackChain(
    ...
    def find_paths_to_high_value(
        ...
        high_value_targets = [
            n.object_id for n in self.nodes.values()
            if n.high_value
        ]
...
class ImpacketWrapper:
    ...
    def __init__(self, impacket_path: str = None):
        ...
        logger.info(f"Impacket wrapper initialized: {len(self.available_tools)} tools available")
...
class TokenImpersonator:
    ...
    def generate_psexec_system_command(
        self,
        command: str = "cmd.exe"
    ) -> str:
        ...
        return [
            {
                ...
                "variants": ["SweetPotato", "JuicyPotato", "RoguePotato", "PrintSpoofer"]
            },
            {
